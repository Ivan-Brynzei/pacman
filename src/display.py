...
class Display:
    ...
    def show_pause(self, screen):
        text = self.font.render(
            "Пауза. Натисніть 'P' щоб продовжити",
            True,
            (255, 255, 255)
        )
        text2 = self.font.render(
            "Натисніть 'M' щоб відкрити меню",
            True,
            (255, 255, 255)
        )
    ...
    def show_menu(
        ...
        play_button = Button(
            "Грати", WIDTH // 2 - 135, HEIGHT // 2 - 50, 270, 50
        )
        change_walls_color_button = Button(
            "Змінити колір стіни", WIDTH // 2 - 135, HEIGHT // 2 + 20, 270, 50
        )
        change_background_color_button = Button(
            "Змінити колір фону", WIDTH // 2 - 135, HEIGHT // 2 + 90, 270, 50
        )
